	...
	<div id="app">
		...
		<div class="conteudo">
			<div class="painel" v-if="!enviado">
				...
				<Rotulo nome="E-mail">
					<!-- v-model.lazy atualiza o valor ao sair do campo -->
					<!-- sem o v-model.lazy será atualizado a cada tecla clicada -->
				...
				<Rotulo nome="Primeira Reclamação?">
					<!-- Two way data bind do v-model => props.value e $emit('input', ) -->
					<Escolha v-model="escolha" /> <!-- v-model é o mesme que utilizar v-bind:value='x' e v-on:input='x = $event.target.value' -->
				</Rotulo>
				<hr>
