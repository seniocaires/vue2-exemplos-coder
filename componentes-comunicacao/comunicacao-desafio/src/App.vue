<template>
	<div id="app">
		...
		<!-- 
			Clona a lista para que alterações no usuario-lista não afete a propriedade no pai.
			Tipos primitivos são passados por cópia. Objetos são passados por referência.
			Ver UsuarioLista => this.usuarios.pop()
		-->
		<!-- <usuario-lista :usuarios="usuarios" /> -->
		<usuario-detalhe />
	</div>
